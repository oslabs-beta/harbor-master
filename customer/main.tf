  ...
  content  = <<-EOF
    ...
    spec:
      ...
      template:
        ...
        spec:
          containers:
            - image: us.gcr.io/a/terraform/solo:latest
...
resource "local_file" "cloudbuild" {
  ...
  content  = <<-EOF
    ...
    service_account: "projects/a/serviceAccounts/a"
    ...
    steps:
      - name: 'gcr.io/cloud-builders/docker'
        ...
        args:
          - 'build'
          - '-t'
          - 'us.gcr.io/a/terraform/solo:latest'
          - '.'
...
resource "docker_image" "image" {
  name = "us.gcr.io/a/terraform/solo:latest"
  build {
    context = ""
    remote_context = "a"
  }
...
data "google_iam_policy" "p4sa-secretAccessor" {
  binding {
    ...
    members = ["serviceAccount:service-a@gcp-sa-cloudbuild.iam.gserviceaccount.com"]
  }
}
